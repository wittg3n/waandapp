...
function HeroSection() {
  return (
    <section
      className=" w-full min-h-screen flex flex-col md:flex-row items-start overflow-hidden"
      dir="ltr"
    >
      <div
      ...
      <div className="w-full md:w-1/2 h-full flex flex-col justify-start p-3 md:p-4">
        ...
        >
          ...
          <div className="flex flex-wrap gap-3 mt-10  justify-center md:justify-end">
            <Button
              className="bg-black border  hover:bg-black/80 duration-200 text-white px-6 py-2 w-1/4 md:w-auto mr-4 pl-8 pr-10 rounded-full"
              size="lg"
            >
              {" "}
              شروع کنید
              <MoveDownLeft className="inline-block mr-2 size-5" />
            </Button>
            <Button
              className="bg-gray-100 border  rounded-full hover:bg-gray-200 duration-200 text-black px-6 py-2 w-1/4 md:w-auto mr-4 pl-10 pr-10 "
              size="lg"
            >
              {" "}
              تماس با ما
