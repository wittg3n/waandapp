...
const repositoryRoot = resolve(blogDirectory, '../..');
...
const nextConfig: NextConfig = {
  env: {
    NEXT_PUBLIC_API_URL: publicHttpUrl('NEXT_PUBLIC_API_URL'),
    NEXT_PUBLIC_BLOG_URL: publicHttpUrl('NEXT_PUBLIC_BLOG_URL'),
    NEXT_PUBLIC_SITE_URL: publicHttpUrl('NEXT_PUBLIC_SITE_URL'),
    NEXT_PUBLIC_USER_DASHBOARD_URL: publicHttpUrl('NEXT_PUBLIC_USER_DASHBOARD_URL'),
  },
  output: 'standalone',
