...
import { motion, type DOMMotionComponents, type MotionProps, type MotionStyle } from 'motion/react';
...
export function LineShadowText({
  ...
  return (
    <MotionComponent
      style={{ '--shadow-color': shadowColor } as MotionStyle}
      className={cn(
        'relative z-0 inline-flex',
        'after:absolute after:top-[0.08em] after:left-[0.08em] after:content-[attr(data-text)]',
        'after:bg-[linear-gradient(45deg,transparent_45%,var(--primary)_45%,var(--primary)_55%,transparent_0)]',
